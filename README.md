...
Your code, when compiled, will produce a single executable file. Depending on what arguments are passed to this executable, a client or a server instance should be started.


>> Network and SHELL Dual Functionality
...
>> SHELL Command Output [IMPORTANT]
...
>> Server/Client SHELL Command Description
...
>> Server SHELL Command/Event Description
...
>> Client SHELL Command/Event Description
